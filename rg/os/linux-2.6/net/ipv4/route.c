 ...
 *
 * Version:	$Id: route.c,v 1.12 2011/12/06 21:28:32 jacoba Exp $
 *
 * Authors:	Ross Biro
...
/* Since Jungo implement routing based on DSCP field, I comment this code,
 * to avoid probable confusion in the future */
#if 0
__u8 ip_tos2prio[16] = {
	TC_PRIO_BESTEFFORT,
	ECN_OR_COST(FILLER),
...
#define EIGHT_TIMES(arg) arg, arg, arg, arg, arg, arg, arg, arg

/* By default, we translate "Precedence" bits according to RFC-791 to priority
 * from 0 to 7 */
__u8 ip_dscp2prio[0x40] = {
	EIGHT_TIMES(0),
	EIGHT_TIMES(1),
	EIGHT_TIMES(2),
	EIGHT_TIMES(3),
				  ...
				  struct rtable **result)
{
	...
	if (skb->protocol != htons(ETH_P_IP)) {
		...
		if ((out_dev == in_dev && !(flags & RTCF_DNAT))
		    ...
		    /* DOCSIS WAN fills the ARP table with many redundant
		     * incomplete entries. filter them out */
