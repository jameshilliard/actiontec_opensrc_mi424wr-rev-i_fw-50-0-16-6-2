...
#define MV_GPP_IRQ_CAUSE_REG(unit)	((MV_6601_DEV_ID == mvCtrlModelGet()) ? (0x18114 + ((unit) * 0x24)) : \
										(0x18114 + ((unit) * 0x40)))

#define MV_GPP_IRQ_EDGE_REG(unit)	((MV_6601_DEV_ID == mvCtrlModelGet()) ? (0x18118 + ((unit) * 0x24)) : \
										(0x18118 + ((unit) * 0x40)))

#define MV_GPP_IRQ_MASK_REG(unit)	((MV_6601_DEV_ID == mvCtrlModelGet()) ? (0x1811c + ((unit) * 0x24)) : \
										(0x1811c + ((unit) * 0x40)))

#define MV_GPP_IRQ_POLARITY(unit)	((MV_6601_DEV_ID == mvCtrlModelGet()) ? (0x1810c + ((unit) * 0x24)) : \
										(0x1810c + ((unit) * 0x40)))
