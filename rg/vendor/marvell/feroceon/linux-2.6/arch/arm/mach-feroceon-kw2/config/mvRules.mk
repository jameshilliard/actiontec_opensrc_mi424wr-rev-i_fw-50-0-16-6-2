...
ifeq ($(CONFIG_FEROCEON_WATCHDOG),y)
...
LSP_PATH_I      = $(CURDIR)/arch/arm/mach-feroceon-kw2
PLAT_PATH_I	= $(CURDIR)/arch/arm/plat-feroceon
...
DRIVERS_LSP_PATH = -I$(PLAT_PATH_I)/$(PLAT_DRIVERS) -I$(PLAT_PATH_I)/$(LSP_NETWORK_DIR) -I$(PLAT_PATH_I)/$(LSP_SWITCH_DIR) \
		   ...
		   -I$(PLAT_PATH_I)/$(LSP_NET_DEV_DIR) -I$(PLAT_PATH_I)/$(LSP_EZXML_DIR) -I$(PLAT_PATH_I)/$(LSP_WATCHDOG_DIR)
...
ifeq ($(CONFIG_MV_INCLUDE_SWITCH)$(CONFIG_MV_INCLUDE_TPM),y)
EXTRA_INCLUDE   += $(QD_PATH)
endif
