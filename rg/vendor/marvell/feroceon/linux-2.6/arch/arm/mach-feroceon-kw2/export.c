...
EXPORT_SYMBOL(bus_find_device_by_name);
...
#endif
EXPORT_SYMBOL(mv_eth_get_txq_cpu_def);
...
/*octavia* - compilation NO_PON fails*/
...
EXPORT_SYMBOL(mvPncAgingCntrWrite);
EXPORT_SYMBOL(mvPncAgingCntrRead);
EXPORT_SYMBOL(mvPncAgingGroupCntrClear);
EXPORT_SYMBOL(mvPncAgingLogEntryRead);
EXPORT_SYMBOL(mvPncAgingCntrLuMaskSet);
EXPORT_SYMBOL(mvPncAgingLuThreshSet);
EXPORT_SYMBOL(mvPncAgingCntrGroupSet);
EXPORT_SYMBOL(mvPncAgingLuReadClear);
EXPORT_SYMBOL(mvPncAgingTrigerSet);
EXPORT_SYMBOL(mvPncAgingCouterClear);
...
EXPORT_SYMBOL(mvNetaPortEnable);
EXPORT_SYMBOL(mvNetaPortDisable);

EXPORT_SYMBOL(mvNetaPortIpgSet);
EXPORT_SYMBOL(mvNetaPortIpgGet);
...
EXPORT_SYMBOL(mv_switch_set_port_preamble);
EXPORT_SYMBOL(mv_switch_get_port_preamble);
