...
#define RG_IOCTL_PREFIX_SWITCH (RG_IOCTL_PREFIX_BASE + 37)
#define RG_IOCTL_PREFIX_KLOG (RG_IOCTL_PREFIX_BASE + 38)
#define RG_IOCTL_PREFIX_ADM6996_SWITCH (RG_IOCTL_PREFIX_BASE + 39)
#define RG_IOCTL_PREFIX_AR8316_SWITCH (RG_IOCTL_PREFIX_BASE + 40)
#define RG_IOCTL_PREFIX_L2TP (RG_IOCTL_PREFIX_BASE + 41)
#define RG_IOCTL_PREFIX_VIRTUAL_WAN (RG_IOCTL_PREFIX_BASE + 42)
#define RG_IOCTL_PREFIX_PPPOS (RG_IOCTL_PREFIX_BASE + 43)
#define RG_IOCTL_PREFIX_PSB6973_SWITCH (RG_IOCTL_PREFIX_BASE + 44)
#define RG_IOCTL_PREFIX_IGMP_PROXY (RG_IOCTL_PREFIX_BASE + 45)
#define RG_IOCTL_PREFIX_FEROCEON_SWITCH (RG_IOCTL_PREFIX_BASE + 46)

#ifdef ACTION_TEC
#define RG_IOCTL_PREFIX_IGMP (RG_IOCTL_PREFIX_BASE + 48)
#define RG_IOCTL_PREFIX_LOG_AGGR (RG_IOCTL_PREFIX_BASE + 49)
#endif /* ACTION_TEC */
