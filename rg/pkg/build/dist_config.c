...
char *act_mv_wifi_ap_ifname;
char *act_mv_wifi_vap_ifname;
/* ACTION_TEC */
...
{
    token_set("CONFIG_RG_HOST_NAME", "Wireless_Broadband_Router"); 
    if (token_get("ACTION_TEC_BRIGHTHOUSE"))
        token_set("RMT_UPG_SITE", "actiontec.bhn.net");
    else
    ...
    token_set("ACTION_TEC_MV_WIFI_IFNAME", act_mv_wifi_ap_ifname);
    token_set("ACTION_TEC_MV_VAP_IFNAME", act_mv_wifi_vap_ifname);
...
void verizon_specific_features(void)
{
    ...
    token_set_y("ACTION_TEC_IGMP_ENABLED");

#if 0
    /* 
     * Turning this feature OFF for now.
     * Will be turned ON after SDK6 demo if needed
     */
    ...
    /* TR-143 support */
    if (token_get("ACTION_TEC_TR143") && token_is_y("ACTION_TEC_TR143"))
        token_set_y("ACTION_TEC_TR143_VZ_EXT");

    if (token_get("CONFIG_AEI_IPV6"))
        token_set_y("CONFIG_VERIZON_TR98_IPV6");
}
/*ACTION_TEC END*/
...
//	enable_module("CONFIG_HW_USB_STORAGE");
	...
	*/
    ...
    else if (IS_DIST("FIBERTEC_FEROCEON"))
    {
	/* Marvell SoC */
	hw = "DB88F6560BP";
	os = "LINUX_26";
	...
	enable_module("MODULE_RG_HOME_PBX");
	token_set_y("CONFIG_RG_VOIP_MEDIA5");
	...
	token_set_y("CONFIG_RG_PERM_STORAGE_UBI");
	/* 62MiB at offset 2MiB (after u-boot) */
	token_set("CONFIG_RG_UBI_PARTITION_SIZE", "0x3e00000");
	/* OpenRG Permst UBI Volume ~58MiB */
    ...
    else if (IS_DIST("VERIZON_FEROCEON"))
    {
	/* Marvell SoC */
	hw = "MI424WR-FEROCEON";
	os = "LINUX_26";
	...
	enable_module("MODULE_RG_DSLHOME");
	enable_module("MODULE_RG_QOS");
	token_set_y("CONFIG_RG_DO_DEVICES");
	enable_module("CONFIG_RG_WPS");
	enable_module("CONFIG_RG_ATHEROS_HW_AR5416");
	...
	//token_set("CONFIG_PING_SITE","www.actiontec.com");
	token_set("FIRM", "Actiontec");
	token_set("CONFIG_RG_HELP_URL",
	    "http://www.actiontec.com/mi424wr/help.html");
	...
	token_set_y("CONFIG_RG_PERM_STORAGE_UBI");
 	/* 30MiB at offset 2MiB (after u-boot) */
 	token_set("CONFIG_RG_UBI_PARTITION_SIZE", "0x1e00000");
	/* OpenRG Permst UBI Volume ~58MiB */
 	token_set("CONFIG_RG_PERM_STORAGE_UBI_VOLUME_SIZE", "0x189c000");

	if (token_get("CONFIG_RG_PERM_STORAGE_UBI"))
	    token_set_y("CONFIG_RG_MTD_UTILS");

	token_set_y("CONFIG_VENDOR_ACTIONTEC");
	token_set_y("CONFIG_RG_VZ_BHR");
	...
	act_atheros_vap_public_ifname="ath3";
        ...
        act_mv_wifi_ap_ifname="wdev0";
        act_mv_wifi_vap_ifname="wdev0ap0";
