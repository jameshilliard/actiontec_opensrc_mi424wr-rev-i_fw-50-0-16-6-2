...
void general_features(void)
{
...
#if 0 //fix for bug #10076 BHR 4.7 sirid
    ...
    /* Jungo source code not include WMM */
    if (token_get("ACTION_TEC_VERIZON"))
        token_set_y("CONFIG_RG_WMM");

    /* WBM */
    if (token_get("ACTION_TEC_VERIZON"))
    {
	token_set_y("CONFIG_RG_WBM_AEI");
	token_set("CONFIG_RG_DEF_THEME", "aei_vz");
    }
    else
...
//	token_set_y("CONFIG_COMCERTO_MSP_HOTPLUG");
	...
	token_set_y("CONFIG_MV88F6500");
        ...
        if (token_get("CONFIG_MV_ETHERNET"))
        {
            ...
            token_set("CONFIG_MV_PNC_TCAM_LINES", "512");
            /* Rx/Tx Queue configuration */
            token_set("CONFIG_MV_ETH_RXQ_DESC", "128");
            token_set("CONFIG_MV_ETH_RXQ_DEF", "0");
            token_set("CONFIG_MV_ETH_TXQ_DESC", "512");
            ...
            token_set("CONFIG_MV_ETH_RX_POLL_WEIGHT", "64");
            token_set("CONFIG_MV_ETH_EXTRA_BUF_SIZE", "120");
            token_set("CONFIG_MV_ETH_EXTRA_BUF_NUM", "532");
        }
	...
	if (token_get("CONFIG_RG_PSE_HW"))
	{
        ...
        if (token_get("CONFIG_RG_WAN_SWAP"))
            token_set_y("CONFIG_MV_ETH_WAN_SWAP");
    ...
    if (token_get("CONFIG_OPENRG") && (token_get("CONFIG_RG_WBM") || token_get("CONFIG_RG_WBM_AEI")))
    {
    ...
    if (token_get("CONFIG_OPENRG") &&
	(token_get("CONFIG_RG_WBM") || token_get("CONFIG_RG_SSI") || token_get("CONFIG_RG_WBM_AEI")))
    {
...
void openrg_features(void)
{
    ...
    if (!token_get_str("RG_PROD_UBI_STR"))
	token_set("RG_PROD_UBI_STR", "OpenRG");
