...
static void handle_opt(int argc, char *argv[])
{
	...
	{
	case 'd':
            //modify here for Bright House
            if (strcmp(optarg, "FEROCEON") == 0)
                dist = "VERIZON_FEROCEON";
            else
                dist = optarg;
	    break;
	case 'c':
...
static code2str_t modules[] = {
	...
	{FEATURE_80211, "CONFIG_HW_80211N_RALINK_RT2860"},
	{FEATURE_80211, "CONFIG_HW_80211N_RALINK_RT2880"},
	{FEATURE_80211, "CONFIG_HW_80211N_RALINK_RT3062"},
	{FEATURE_80211, "CONFIG_HW_80211N_RALINK_RT3052"},
	{FEATURE_80211, "CONFIG_RG_ATHEROS_HW_AR5212"},
	{FEATURE_80211, "CONFIG_RG_ATHEROS_HW_AR5416"},
	{FEATURE_80211, "CONFIG_HW_80211N_LANTIQ_WAVE300"},
	{FEATURE_80211, "CONFIG_HW_80211N_AIRGO_AGN100"},
	{FEATURE_80211, "CONFIG_HW_80211N_BCM338X"},
	{FEATURE_80211, "CONFIG_HW_80211G_UML_WLAN"},
	{FEATURE_80211, "CONFIG_RG_WPS"},
	...
	{FEATURE_SNMP, "MODULE_RG_SNMP_CLIENT"},
	{FEATURE_DSL, "MODULE_RG_DSL"},
	{FEATURE_PPP, "MODULE_RG_PPP"},
	{FEATURE_IPV6, "MODULE_RG_IPV6"},
	{FEATURE_IPV6_OVER_IPV4_TUN, "MODULE_RG_IPV6_OVER_IPV4_TUN"},
	...
	{FEATURE_VIDEO_SURVEILLANCE, "MODULE_RG_VIDEO_SURVEILLANCE"},
	{FEATURE_VAS_CLIENT, "MODULE_RG_VAS_CLIENT"},
	{FEATURE_DLM, "MODULE_RG_MODULAR_UPGRADE"},
	{FEATURE_CHILDREN_NETWORK, "MODULE_RG_CHILDREN_NETWORK"},
	{-1}
    };
...
void _enable_module(char *file, int line, char *name)
{
    ...
    {
	conf_err("ERROR: %s:%d: Mapping to the %s module is missing "
	    "in create_config.c, please add one\n", 
	    file, line, name);
    }
#endif
...
{
    /* Hardware independent wireless features */
    wireless_features();
    hardware_features();

    /* Adding common features */
    openrg_features();
    /* Hardware dependent wireless features -
     * Should be called after hardware_features() */
    hw_wireless_features();
    general_features();
}
