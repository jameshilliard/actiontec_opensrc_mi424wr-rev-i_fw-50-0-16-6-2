...
#include "../../../../pkg/include/external_version_data.h"

/************/
/* VERSIONS */
/************/
#define CONFIG_IDENT_STRING	" Marvell version: 3.2.0_NQ Actiontec version: " EXTERNAL_VERSION
...
#if defined(MI424WR_I) || defined(MI424WR_J)
...
/*****************************/
	...
	/* Boot from SPI settings */
		...
		#define CONFIG_ENV_SIZE		4096 /* CONFIG_ENV_SECT_SIZE */
...
/************************/
	...
	#define ENV_MTDPARTS \
		...
		"mtdparts=mtdparts=nand_mtd:2M(UBOOT),30M(UBI),-(FS)\0"
	#define ENV_BOOTCMD \
		"bootcmd=ubi part UBI; dualimage; set verify n; set bootargs ${mtdparts}; bootm ${openrg_start}\0"
	#define ENV_BUBI \
	 	"bubi=nand erase 0xc0000; tftp 0x02000000 ubi.img; nand write 0x2000000 0x00200000 $filesize\0"
        #define ENV_BOOTNET \
                "bootnet=tftp 0x02000000 openrg.img; set bootargs ${mtdparts}; bootm 0x02000000\0"
#endif
	...
	/* JFFS2 partition offset and size */
	#define CONFIG_JFFS2_PART_OFFSET	0x00600000
	#define CONFIG_JFFS2_PART_SIZE		0x1Fa00000	/* sz of jffs2 part - 506 MB */

	#define CONFIG_JFFS2_NAND_OFF		0
	#define CONFIG_JFFS2_NAND_SIZE		506*1024*1024
